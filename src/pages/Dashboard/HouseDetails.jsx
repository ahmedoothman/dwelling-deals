...
function HouseDetails() {
  ...
  const house = houses[30];
  console.log("singleHouse", houses[30]);
        ...
        >
          ...
          <Box display={"flex"} flexDirection={"row"} flexWrap={"wrap"} gap={1}>
            ...
            >
              ...
              <Typography variant="body1">{house.price} Price</Typography>
            </Box>
            ...
            >
              ...
              <Typography variant="body1">{house.area} Area</Typography>
            </Box>
          </Box>
        </Box>
      </Box>
