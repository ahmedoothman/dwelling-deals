        ...
        <CardActionArea>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" textAlign={"center"}>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet minima modi quidem quisquam voluptatem nobis accusantium odio
            </Typography>
          </CardContent>
        </CardActionArea>
        <CardActions>
          <Button variant="outlined" sx={{ margin: "auto", textTransform: "capitalize", color: "#201E43", borderColor: '#201E43' }}>
            Find a rental
          </Button>
        </CardActions>
      </Card>
